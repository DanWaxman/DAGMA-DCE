# Modified from https://github.com/kevinsbello/dagma/blob/main/src/dagma/utils.py
...
def count_accuracy(B_true: np.ndarray, B_est: np.ndarray) -> dict:
    ...
    # f1
    f1 = 2 * (1 - fdr) * tpr / (max(1 - fdr + tpr, 1e-10))
    return {"fdr": fdr, "tpr": tpr, "fpr": fpr, "shd": shd, "nnz": pred_size, "f1": f1}
